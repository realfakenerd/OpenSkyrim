...
- Developers and modders can edit `.lua` scripts, glTF `.glb` models, or UI layouts in an external editor (VS Code, Neovim) and see updates **reflected instantly in-game** without restarting the client.
