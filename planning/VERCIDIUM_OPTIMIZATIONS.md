...
Inspired by key engine optimizations demonstrated by **Vercidium** (developer of the custom high-FPS engine *Sector's Edge*).
...
| **Script Threading** | Single-threaded VM (Papyrus blockages) | **Parallel Lua 5.4 Fiber Coroutines** |
